...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* ── 1. Ambient spotlight — very faint neutral indigo, atmospheric only */}
      <div
        aria-hidden="true"
        ...
        return (
          ...
          >
            ...
            >
              ...
              >
                <Icon size={10} strokeWidth={2} style={{ color: node.color, flexShrink: 0 }} />
                <span style={{ color: 'rgba(226,232,240,0.60)', fontSize: 11, fontWeight: 500, letterSpacing: '-0.01em' }}>
                  {node.id}
                </span>
              </div>
            </motion.div>
